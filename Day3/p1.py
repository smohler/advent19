...
wirePorts1 = data[0].split(',')
wirePorts2 = data[1].split(',')
...
Xs = n.absolute(Intersections(p,q)) #taxi cab norm is sum of absolute values of points 
Manhattan = Xs.sum(axis = 1)
print(Manhattan)
minDistance = n.min(Manhattan)
print(minDistance)